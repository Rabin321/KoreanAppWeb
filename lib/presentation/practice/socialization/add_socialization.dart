...
class AddSocialization extends StatefulWidget {
  static const String id = "addsocialization";

  const AddSocialization({super.key});

  @override
  State<AddSocialization> createState() => _AddSocializationState();
}

class _AddSocializationState extends State<AddSocialization> {
  ...
  void save() async {
    ...
    if (pickedImage == null) {
      ...
      if (parsedValue < 1 || parsedValue > 4) {
        ...
        await uploadImages();
        await PracticeSocializationModel.addPracticeSocialization(
