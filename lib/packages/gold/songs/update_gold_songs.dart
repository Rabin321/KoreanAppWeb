...
class UpdateGoldSongs extends StatelessWidget {
  static const String id = "updategoldsongs";

  const UpdateGoldSongs({super.key});
                ...
                child: StreamBuilder(
                  ...
                  builder: (BuildContext context,
                    ...
                    return DataTable(
                      ...
                      columnSpacing: 200.w,
                      columns: const [
                        DataColumn(label: Text('Song Title')),
