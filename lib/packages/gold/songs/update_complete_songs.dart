...
class UpdateCompleteGoldSongs extends StatefulWidget {
  String? id;
  GoldSongsModel? goldSongsModel;
  UpdateCompleteGoldSongs({
    Key? key,
    this.id,
    this.goldSongsModel,
  }) : super(key: key);
  ...
  @override
  State<UpdateCompleteGoldSongs> createState() =>
      _UpdateCompleteGoldSongsState();
}

class _UpdateCompleteGoldSongsState extends State<UpdateCompleteGoldSongs> {
  ...
  @override
  void initState() {
    titleGoldSong.text = widget.goldSongsModel!.title;
    pickedAudio = XFile(widget.goldSongsModel!.audioUrl);
  ...
  save() async {
    ...
    if (titleGoldSong.text.isEmpty || pickedAudio == null
      ...
      await GoldSongsModel.updateAudio(
          widget.id!,
          GoldSongsModel(
            id: uuid.v4(),
