...
import 'package:korean_app_web/packages/gold/movies/update_complete_gold_movies.dart';
...
class UpdateGoldMovie extends StatelessWidget {
  static const String id = "updategoldmovie";

  const UpdateGoldMovie({super.key});
                              ...
                              Row(
                                ...
                                children: [
                                  ElevatedButton(
                                      ...
                                      onPressed: () {
                                        GoldMovieModel.deleteGoldMovie(
                                            data[index].id);
                                      },
