...
class AddGoldBooks extends StatefulWidget {
  static const String id = "addgoldbooks";

  const AddGoldBooks({super.key});

  @override
  State<AddGoldBooks> createState() => _AddGoldBooksState();
}

class _AddGoldBooksState extends State<AddGoldBooks> {
  ...
  save() async {
    ...
    if (titleGoldBook.text.isEmpty) {
      ...
      await GoldBooksModel.addGoldBooks(GoldBooksModel(
              id: uuid.v4(),
